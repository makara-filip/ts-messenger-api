import { ApiCtx, ApiOptions, AppState, Credentials } from './lib/types';
...
let ctx: ApiCtx | null = null;
let defaultFuncs = null;
let api = null;

export default function login(
  loginData: Credentials | { appState: AppState },
  options: ApiOptions,
...
function buildAPI(globalOptions: ApiOptions, html: string, jar) {
